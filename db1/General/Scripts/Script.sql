...
SELECT '1300' - '1200' AS TOT FROM DUAL;


SELECT TO_NUMBER('1,300','999,999') - TO_NUMBER('1,200' , '999,999')  FROM DUAL; 



SELECT TO_DATE('2018-01-12','YYYY-MM-DD') AS TODATE1,
TO_DATE('20180112','YYYY-MM-DD') AS TODATE2
FROM DUAL;
*/
