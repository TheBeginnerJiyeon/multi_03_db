...
CREATE TABLE REPLY4(
	...
	CONSTRAINT F1 FOREIGN KEY (ORIID) REFERENCES BBS4(NO),
	CONSTRAINT F2 FOREIGN KEY (WRITER) REFERENCES MEMBER4(ID)
...
INSERT INTO USER_FOREIGNKEY
    (USER_NO, USER_ID , USER_PWD , USER_NAME , GENDER , PHONE , EMAIL , GRADE_CODE)
    VALUES
    (2, 'user02', 'pass01', '유재석', '남', '010-1234-5678', 'yu@naver.or.kr' ,NULL);


INSERT INTO USER_FOREIGNKEY
    (USER_NO, USER_ID , USER_PWD , USER_NAME , GENDER , PHONE , EMAIL , GRADE_CODE)
    VALUES
    (3, 'user03', 'pass01', '유재석', '남', '010-1234-5678', 'yu@naver.or.kr' ,50);


INSERT INTO USER_FOREIGNKEY
    (USER_NO, USER_ID , USER_PWD , USER_NAME , GENDER , PHONE , EMAIL , GRADE_CODE)
    VALUES
    (4, 'user04', 'pass01', '유재석', '남', '010-1234-5678', 'yu@naver.or.kr' ,30);
...
CREATE TABLE MEMBER41 
AS SELECT * FROM MEMBER4;

INSERT INTO MEMBER41  values('100','100','PARK','123');
INSERT INTO MEMBER5  values('100','100','PARK','123');
COMMIT;

SELECT * FROM MEMBER41 ;


CREATE TABLE MEMBER5 
AS SELECT * FROM MEMBER41;

DROP TABLE MEMBER5;

CREATE TABLE MEMBER5
AS SELECT * FROM MEMBER4 WHERE ID='10';

SELECT * FROM MEMBER4;

UPDATE MEMBER4 SET ID=10 ;

SELECT * FROM MEMBER5;

CREATE TABLE MEMBER5 AS
SELECT * FROM MEMBER4 WHERE 1=0; --구조만 복사하고 싶을 때


SELECT * FROM MEMBER4 WHERE 1=1
AND ID==100 AND PW==100;
...
INSERT INTO MEMBER5  values('20','100','PARK','123');
COMMIT;

SELECT * FROM MEMBER5;
UPDATE MEMBER5 SET ID='10' WHERE ID='100';
...
-- INTEGRITY CONSTRAINT (SCOTT.SYS_C007414) VIOLATED - PARENT KEY NOT FOUND
...
MODIFY TABLE TEST22 MODIFY LOC CONSTRAINT NN_LOC  NULL;
...
-- CASCADE CONSTRAINT : 제약조건까지 함깨 삭제
...
SELECT * FROM MEMBER ORDER BY ID; -- 오름차순(디폴트)

SELECT * FROM MEMBER ORDER BY ID DESC; -- 내림차순


SELECT * FROM MEMBER ORDER BY 2; -- 오름차순 PW 기준, * 기준이라 컬럼 순서를 다르게 하면 그 달라진
-- 순서의 2번째로 정렬된다
